        ...
        var vmodel = avalon.define(data.dropdownId, function(vm) {
            ...
            vm._position = function() {
                ...
                if(offsetParent && (offsetParent.tagName !== "BODY" && offsetParent.tagName !== "HTML")) {
                    ...
                    css.left = offset.left - $offsetParent.offset().left + listNode.offsetParent.scrollLeft - ($offsetParent.css("borderLeftWidth").replace(styleReg, "$1") * 1 + $offsetParent.css("borderRightWidth").replace(styleReg, "$1") * 1) / 2;
            ...
            vm.scrollTo = function(activeIndex) {
                ...
                var nodes = siblings(vmodel.dropdownNode.firstChild),
                    ...
                    nodeTop = $activeNode.offsetParent()[0] ? $activeNode.position().top - avalon(nodes[0]).position().top : 0,
