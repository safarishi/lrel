 ...
 */
define(["avalon", "text!./avalon.scrollbar.html", "../draggable/avalon.draggable"], function(avalon, template) {
        ...
        var vmodel = avalon.define(data.scrollbarId, function(vm) {
            ...
            vm.update = function(ifInit, x, y) {
                ...
                var hPadding = scroller.width() - scroller.innerWidth(),
                    // 竖直方向内间距
                    vPadding = scroller.height() - scroller.innerHeight() + vmodel.paddingVertical
                scroller.css("height", h + vPadding - vmodel.paddingVertical)
                ...
                avalon.each(vmodel._position, function(i, item) {
                    ...
                    if(bar) {
                        ...
                        if(bars.length > 1) {
                            ...
                            if(isVertical) {
                                draggerParCss = [
                                    ["top", (bw + vmodel.paddingVertical / 2)],
                                    ["height", (barH - bw * 2 - vmodel.paddingVertical)]
                                ]
                            } else {
                                draggerParCss = [
                                    ["left", bh],
